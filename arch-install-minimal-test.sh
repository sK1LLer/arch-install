...
#MINIMAL
pacstrap -K /mnt base linux linux-firmware $ucode fwupd networkmanager btrfs-progs bash-completion grub efibootmgr reflector sudo nano sddm konsole dolphin kate os-prober breeze-gtk plasma-desktop plasma-disks plasma-nm plasma-pa plasma-systemmonitor
